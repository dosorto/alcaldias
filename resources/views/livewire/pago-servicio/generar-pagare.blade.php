<div>
            ...
            <div class="grid">
                ...
                <form wire:submit.prevent="store()" class="flex gap-4 h-10 w-96" id="miFormulario">
                    ...
                    <div class="content-center justify-center place-content-center">
                        @if ($serviceSelected)
                        <button wire:click="abrirPrecio()" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                            Seleccionar
                          </button>
                        @endif
    ...
    @include('livewire.pago-servicio.editarPrecio')
