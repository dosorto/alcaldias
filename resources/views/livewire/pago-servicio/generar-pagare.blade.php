...
<div id="errorMessage" duration=30 class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800" role="alert">
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="/pago-servicio" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Pago de Servicios</a>
        </div>
      </li>
      <li>
        <div class="flex items-center">
          ...
          <a class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Generar Pagare</a>
        </div>
      </li>
...
<div class="flex justify-between mb-5">
    <div>
        <img class="rounded-full w-20 h-20" src="https://cdn-icons-png.flaticon.com/512/2922/2922616.png" alt="image description">
    </div>
...
<div class="flex justify-between gap-8">
    <div class="grid">
    <h1 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white text-center">Seleccionar Servicio</h1>
        <form wire:submit.prevent="store()" class="flex gap-4 h-10 w-96">
            <div>
                <input size="70" list="drawfemails" wire:model.live="serviceSelected"
                type="text" placeholder="Buscar..." class="w-full mb-4 px-3 py-2 border border-gray-300 rounded-md">
        ...
        <h1 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white text-center">Suscripciones del contribuyente</h1>
        <ul class="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <li class="pb-3 sm:pb-2 sm:pt-2">
                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                   ...
                   <div class="inline-flex min-w-20 justify-center">
                    <button wire:click="storeSubs({{ $sus->servicios->id }})" type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm p-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Seleccionar
                    </button>
                   </div>
                </div>
    ...
    <div class="w-full max-h-80">
        <div  class="flex justify-between gap-4 h-10 w-full">
            <div class="flex-1">
                <h1 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white text-center">Servicios seleccionados a pagar</h1>

            </div>
            <div align="rigth">
                <button wire:click.prevent="guardarRegistro()" type="button" class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm p-2 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Generar
                </button>
            </div>
        </div>
            ...
            @forelse ($listaPagare as $lista)
                ...
                @endforeach
                    ...
                    <td class="px-6 py-4">
                        ...
                        <button disabled type="button" class="text-white bg-red-900  font-medium rounded-lg text-sm p-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            {{ $lista->estado }}
                        </button>
                        @else
                        <button disabled type="button" class="text-white bg-green-900  font-medium rounded-lg text-sm p-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            {{ $lista->estado }}
                        </button>
                        @endif
