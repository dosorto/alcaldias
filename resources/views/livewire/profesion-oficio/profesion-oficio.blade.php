            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/departamentos"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Profesión
                        u Oficio</a>
                </div>
            </li>
            ...
            <tbody>
                @forelse ($profesiones as $prof)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <button wire:click="edit({{ $prof->id }})" type="button"
                            ...
                            <button wire:click="remove({{ $prof->id }})" type="button"
