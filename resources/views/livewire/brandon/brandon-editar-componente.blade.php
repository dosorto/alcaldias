    ...
    <form action="">
        <div class="mb-3 mt-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="dni" wire:model="dni" required/>
          </div>
          <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Sexo</label>
            <select class="form-select" aria-label="Default select example" id="sexo" wire:model="sexo" required/>
          ...
          <button wire:click.prevent="guardar()"  type="submit" class="btn btn-success">guardar</button>
