        ...
        <div class="flex items-center justify-between md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900">
            ...
            <div>
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button wire:click="openModalCreate()" data-modal-target="create-propiedad-modal" data-modal-toggle="create-propiedad-modal" type="button"
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button wire:click="openModalDelete({{ $propiedad->id }})"
                                class="inline-flex items-center text-red-600 dark:text-red-500 hover:underline">
                                Eliminar
                            </button>
                        </td>
                    </tr>
