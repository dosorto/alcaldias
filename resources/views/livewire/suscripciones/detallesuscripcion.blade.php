<div>
    ...
    <div class="flex flex-col items-center dark:bg-gray-900">
        ...
        <div class="w-full bg-white shadow-md rounded px-8 pt-8 pb-8 mb-4 dark:bg-gray-900">
            ...
            <!-- Filtro por año -->
            <div class="mb-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white text-center mb-2"><u>Agregar Nueva
                        Suscripción</u></h2>
                <br>
                <div class="flex space-y-1"> <!-- Formulario para agregar una nueva suscripción -->
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white text-center mb-2"><u>Lista de
                        Suscripciones</u></h2>
                        ...
                        @forelse ($suscripciones as $sus)
                            @if ($sus->contribuyente_id == $contribuyente->id)
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <button type="button" wire:click="opendelete({{ $sus->id }})"
