    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white text-center mb-2">Agregar Nueva Suscripción</h2>
            ...
            <form class="max-w-sm mx-auto" wire:submit.prevent="agregarServicio()" >
                ...
                <select wire:model="servicioId" name="servicioId" id="servicioId" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                        <button wire:click="opendelete({{ $sus->id }})" type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Eliminar</button>
                </td>
            </tr>
            @endif
            @empty
