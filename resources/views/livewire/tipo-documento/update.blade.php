        ...
        <div class="bg-white p-4 min-w-96 max-w-md mx-auto rounded-md dark:bg-gray-900">
            ...
            <div class="p-4 md:p-4">
                <form class="space-y-4" wire:submit.prevent="update()">
                    <div>
                        <label for="tipo_documento" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo Documento</label>
                        <input type="text" wire:model="tipo_documento" name="tipo_documento" id="tipo_documento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Tipo documento" required />
