                ...
                @if($pais !== null)
                    @forelse ($pais as $pa)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">{{ $ser->tiposervicio->name }}</td>
                            <td class="px-6 py-4">{{ $ser->tiponivel->name }}</td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button wire:click="remove({{$ser->id}})"     type="button" class="text-white bg-red-700 hover:bg-red-800  font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" data-bs-toggle="modal" data-bs-target="#delete-modal">
                                    <svg class="w-6 h-6  dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
