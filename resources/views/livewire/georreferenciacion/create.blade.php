        ...
        <div class="bg-white p-4 min-w-96 max-w-md mx-auto rounded-md dark:bg-gray-900">
            ...
            <div class="flex items-center justify-between border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                    Crear Nueva georreferenciacion
                </h3>
            ...
            <div class="p-4 md:p-4">
                <form class="space-y-4" wire:submit.prevent="store()">
                    <div>
                        <label for="tipo_Propiedad" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo Propiedad</label>
                        <input type="text" wire:model="Nombre" name="tipo_Propiedad" id="tipo_Propiedad" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        placeholder="Tipo de Propiedad" required />
                        @error('tipo_Propiedad') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
