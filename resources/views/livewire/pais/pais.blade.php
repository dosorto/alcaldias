        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/pais"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Pais</a>
                </div>
            </li>
        ...
        <div
            ...
            <div>
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    ...
                    <button type="button" wire:click='nuevoModal()'
                        ...
                        data-bs-toggle="modal" data-bs-target="#paisModal">
                    ...
                    <button type="button"
                        ...
                        <svg class="w-3 h-3 me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                d="M18 12h-2.55l-2.975 2.975a3.5 3.5 0 0 1-4.95 0L4.55 12H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2Zm-3 5a1 1 0 1 1 0-2 1 1 0 1 1 0 2Z" />
                        </svg>
                        Exportar
                    </button>
                </div>
                ...
                @if ($pais !== null)
                    @forelse ($pais as $pa)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <button type="button" wire:click="edit({{ $pa->id }})"
                                ...
                                <button wire:click="remove({{ $pa->id }})" type="button"
