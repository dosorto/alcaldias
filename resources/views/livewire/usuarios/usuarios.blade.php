                    ...
                    @foreach ($users as $user)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button wire:click="remove({{ $user->id }})" type="button"
                            ...
                            <td>
                                <form action="{{ route('assign.role') }}" method="POST">
                                    ...
                                    <button type="submit"
                                        class="text-white bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"">Asignar</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
