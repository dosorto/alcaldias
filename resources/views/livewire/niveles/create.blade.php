        ...
        <div class="bg-white p-4 min-w-96 max-w-md mx-auto rounded-md">
            ...
            <div class="p-4 md:p-4">
                <form class="space-y-4" wire:submit.prevent="store()">
                    <div>
                        <label for="clave" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Clave Presupuestaria</label>
                        <input type="text" wire:model="clave" name="clave" id="clave" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
