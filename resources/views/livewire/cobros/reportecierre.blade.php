<div id="estilo" class="flex flex-wrap">
    <div class="w-full md:w-1/3 p-3">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 dark:bg-gray-900">
            ...
            <hr class="border-t border-gray-300 mb-4">
            <p class="text-xl font-bold mb-3 dark:text-white"><b>Monto de cierre:</b> {{ $totalCaja ?? 'Total no disponible' }}</p>
        ...
        <div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3" role="alert" id="alertaCierre" style="display: none;">
            ...
            <div class="flex flex-wrap justify-between mb-4 dark:bg-gray-900">
                <form wire:submit.prevent="cerrarSesionCaja" class="mt-4">
                    <h2 class="text-xl font-bold mb-3 dark:text-white">Monto de Cierre</h2>
                    <label class="text-xl font-bold mb-3 dark:text-white" for="montoCierreUser" class="block">Ingrese la cantidad de dinero en caja:</label>
            ...
            <div style="overflow-x: auto;">
                <h2 class="text-xl font-bold mb-3 dark:text-white">Operaciones realizadas en la sesión</h2>
