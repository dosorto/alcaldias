...
>>>>>>> 1f1f74b41722c0d40cf57e14ade7a2169bdf25e4
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            <li>
                                <a href="/perfil_usuario"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">{{ Auth::user()->name }}</a>
                            </li>
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="/departamentos"
                                        ...
                                        <span class="flex items-center">
                                            ...
                                            <svg class="w-6 h-6 ml-2 text-gray-800 dark:text-white"
                                ...
                                <a href="/profesion-oficio"
                                    ...
                                    <span>Profesión u Oficio</span>
                                        <svg height="26px" width="26px" version="1.1" id="_x32_"
                                            xmlns="http://www.w3.org/2000/svg"
...
>>>>>>> 1f1f74b41722c0d40cf57e14ade7a2169bdf25e4
            ...
            <li>
                ...
                <div id="dropdownNavbar1"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                        <li>
                            <a href="/sesiones"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cobros</a>
                        </li>

                        <li>
                            <a href="/reporte"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Reporte de ingresos</a>
                        </li>
                        <li>
                            <a href="#"
            ...
            <li>
                <button id="dropdownNavbarLink2" data-dropdown-toggle="dropdownNavbar2"
                    ...
                    Ciudadana <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
                    </svg></button>
